...
class HistorisSelesai extends StatefulWidget {
  @override
  _HistorisSelesaiState createState() => _HistorisSelesaiState();
}

class _HistorisSelesaiState extends State<HistorisSelesai> {
  var _orderid;
  var _alamat;
  var _estimasi;
  var _status;
