...
class HistorisKonfirmasi extends StatefulWidget {
  @override
  _HistorisKonfirmasiState createState() => _HistorisKonfirmasiState();
}

class _HistorisKonfirmasiState extends State<HistorisKonfirmasi> {
  var _orderid;
  var _alamat;
  var _estimasi;
  var _status;
